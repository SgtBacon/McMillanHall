...
void Room::DoorsOfMac() {
    string line;
    ifstream fin;
    string path="C:\\Users\\User\\Desktop\\CS_Assignments\\CS_Final\\TextFilesForRooms\\FirstFloor\\DoorsOfMac.txt";
    fin.open(path);
...
do 
{
    ...
    switch ( chmenu ) {
        case '1': fin.close();
        cout << "you found a sword! This is where a sword would be if I programmed it yet!" << endl;
        FirstRoom();
        break;
        case '2': fin.close();
        FirstRoom();
...
do 
{
    ...
    switch ( chmenu ) {
        case '1': fin.close();
        cout << "This is where you will grab a key when I add an inventory and the ability to take things from rooms." << endl;
        break;
        case '2': fin.close();
        LeftHallway();
        break;
